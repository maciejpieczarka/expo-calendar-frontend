...
const NativeSelectScrollView = forwardRef<
  ScrollView,
...
>(({ className, ...props }, ref) => {
  ...
  return (
    <ScrollView ref={ref} className={cn('max-h-52', className)} {...props} />
  );
});

NativeSelectScrollView.displayName = 'NativeSelectScrollView';
